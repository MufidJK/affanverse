 ...
 */
const AmbasukeEngine = dynamic(
  () => import("./AmbasukeEngine").then((mod) => mod.default as ComponentType),
  {
    ssr: false,
    loading: () => (
...
export default function AmbasukeProtocolPage() {
  return <AmbasukeEngine />;
}
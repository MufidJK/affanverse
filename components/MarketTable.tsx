...
export function MarketTable({ initialAssets }: MarketTableProps) {
  const { liveAssets, isMounted } = useMarketTicker(initialAssets);
          ...
          {sortedAssets.map((asset, index) => {
            ...
            return (
              ...
              >
                ...
                <td className={`py-4 px-4 font-mono transition-colors duration-300 ${colorClass}`}>
